...
public class Wheres {
    ...
    public static Where equal(final String columnName, final Object value) {
        return new Where(StringUtils.append(columnName, " = ? "), value);
    }
    ...
    public static Where isNotNull(final String columnName) {
        return new Where(StringUtils.append(columnName, " IS NOT NULL "));
    }

    public static Where isNull(final String columnName) {
        return new Where(StringUtils.append(columnName, " IS NULL "));
    }
    ...
    public static Where like(final String columnName, final Object value) {
        return new Where(StringUtils.append(columnName, " like ? "), value);
    }
    ...
    public static Where in(final String columnName, final Object[] values) {
        ...
        inSql.append(" ) ");
        return new Where(String.format(inSql.toString(), columnName), sqlVal);
    }
